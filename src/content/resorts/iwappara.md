...
contact:
  address:
    zhTw: 〒949-6103 新潟縣南魚沼郡湯澤町土樽 731-79
    ja: 〒949-6103 新潟県南魚沼郡湯沢町土樽731-79
    en: 731-79 Tsuchitaru, Minamiuonuma District Yuzawa, Niigata 949-6103
    googleMaps: https://maps.app.goo.gl/gHpyTXkkacTJhz7RA
  phone: 025-787-3211
season:
  label: 2025-2026
...
courses:
  ...
  - name: 16 クルーズコース
    ...
    maxSlope: 12°
    averageSlope: 7°
    note: 岩原唯一的林間路線，從山頂緩慢下降，坡度平緩但部分路段較窄，初級者適合放慢速度欣賞景色。
    videoLinks:
  ...
  - name: 18 ロマンスコース
    ...
    maxSlope: 18°
    averageSlope: 13°
    note: 沿ロマンスリフト的緩坡，可作為初級者嘗試未整雪感覺的入門路線，鄰近ファインスノーバーン區域。
  - name: 19 ファインスノーバーン
    difficulty: beginner
    length: 650m
    videoLinks:
  ...
  - name: 10 フロントコース
    ...
    maxSlope: 22°
    averageSlope: 13°
    note: 抵達岩原時容易先看到的寬雪道，前段可輕鬆滑行，中段後坡度逐漸變陡，適合中級者練習控制。
    videoLinks:
  ...
  - name: 11 レーサーズコース
    ...
    maxSlope: 24°
    averageSlope: 22°
    note: 穿過ペアパラレルリフト後進入的中斜面，寬度較窄、坡度有手感，適合中級以上滑雪者練習節奏。
  - name: 12 ジャイアントコース
    difficulty: advanced
    length: 600m
    maxSlope: 35°
    averageSlope: 18°
    note: 最大斜度 35° 的急斜面，上部為未整雪自由區，新雪隔天可遇到粉雪條件，是岩原代表性的上級路線。
  - name: 14 ダイナミックコース
    difficulty: intermediate
    length: 650m
    maxSlope: 30°
    averageSlope: 28°
    note: 斜面具自然 bank 地形，雪況可能在新雪、深雪與饅頭坡之間變化，挑戰性明顯高於一般中級路線。
    videoLinks:
    - https://www.youtube.com/watch?v=-dYOYpQU_6Y&t=560s
  - name: 15 テクニカルコース
    difficulty: advanced
    length: 1,200m
    maxSlope: 35°
  ...
  - name: 17 ナチュラルコース
    ...
    maxSlope: 30°
    averageSlope: 28°
    note: 起滑段是未整雪急坡，距離感比看起來更吃力；粉雪日適合留下新雪軌跡，雪況轉硬後則偏不整地練習。
lifts:
  total: 9
access:
  fromTokyo:

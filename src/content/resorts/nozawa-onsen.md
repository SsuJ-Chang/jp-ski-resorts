...
courses:
  ...
  - name: 7 KOKENASHI-B
    difficulty: beginner
    note: 位於山頂區域下方的小緩坡。對於沒辦法滑中高級道、卻又想上山頂欣賞全景與霧冰景觀的初學者來說，是唯一的安全練習安全區。
    length: 200m
  - name: 8 UENOTAIRA
    difficulty: beginner
    length: 2,000m
  ...
  - name: 32 ISEMIYA
    difficulty: beginner
    note: 位於雪場西側的聯絡綠道。它的核心功能是讓住宿在西側村落、或將車輛停在西側停車場的滑雪客，在傍晚可以直接滑雪板回到住處附近。
    length: 300m
  - name: 33 NAGASAKA
    difficulty: beginner
  ...
  - name: 38 NAGASAKA-LINK
    difficulty: beginner
    note: 全雪場最偏南邊的悠閒林間綠道。主要引導滑雪客滑向雪場南側邊界，坡度非常柔和，適合體力消耗大時用來放鬆。
    length: 1,000m
  - name: 39 KUMATAKA
    difficulty: beginner
    note: 一條極短、寬度僅容數人通過的交通便道，純粹用於連接中尾地區部分溫泉民宿與纜車站之間的移動。
    length: 1,300m
  - name: 40 KITSUNE
    difficulty: beginner
  ...
  - name: 1 YAMABIKO-A
    ...
    note: 山頂最具代表性的中級滑道。雪道前半段視野極佳，下半段則轉為具備一定速度感的寬敞坡面，是全山最受歡迎的熱身路線。
    length: 1,300m
  - name: 2 YAMABIKO-B
    difficulty: intermediate
    note: 沿著山脊稜線延伸的爽快路線。風大的日子容易形成天然的微幅波浪地形，適合進階滑雪者練習中高速的 Carving 轉彎。
    length: 800m
  - name: 3 YAMABIKO-C
    difficulty: intermediate
    note: 雪道寬度適中，地形帶有自然的起伏與轉折。由於兩側常有未整雪的鬆雪積存，是單板滑雪者極愛切入尋找粉雪的寶地。
    length: 850m
  - name: 4 YAMABIKO-D
    difficulty: intermediate
  ...
  - name: 19 UTOPIA-A
    difficulty: intermediate
    note: UTOPIA 主要雪道的衍生旁支。人煙相對稀少，雪道寬度雖然變窄，但提供了更多林蔭與地形微幅變化的滑行樂趣。
    length: 400m
  - name: 20 UTOPIA-B
    difficulty: intermediate
    note: 過去專為旗門賽事與專業競技設計的封閉型陡坡。雪面通常被整理得非常接近冰面硬實，滑行速度極快，屬於技術流高手的專屬領域。
    length: 350m
  - name: 26 SKYLINE
    difficulty: intermediate
  ...
  - name: 37 RINKAN-SHORT CUT
    difficulty: intermediate
    note: 人煙罕至的隱藏版中級紅道。因為位置較為邊緣，這裡通常能維持非常完美的壓雪狀態，是練習精緻 Carving 的絕佳無人區。
    length: 250m
  - name: 42 KAMOSHIKA
    difficulty: intermediate
  ...
  - name: 11 YUNOMINE
    difficulty: advanced
    note: 位於上之平左側的幽靜支線。雖然雪道寬度較窄，但因為人潮較少且坡度平緩，是想要遠離主幹線人潮、安靜練習滑行者的隱藏路線。
    length: 700m
  - name: 12 MIZUNASHI-A
    difficulty: advanced
    note: 連接上之平與下段區域的急下坡紅道。因為地形收窄且容易在午後因滑雪客推雪而產生小碎雪饅頭，滑行時需要多加留意核心與控板。
    length: 800m
  - name: 13 MIZUNASHI-B
    difficulty: advanced
    note: 一條橫向切出的過渡平道。主要目的是為了讓不想直接挑戰陡坡的滑雪客，能從上之平區域安全橫向移動至日影區或挑戰區的底部。
    length: 700m
  - name: 14 BUNA-BAYASHI
    difficulty: advanced
    note: 建立在上之平寬廣地形上的特技公園。裡面依照季節會設置初級到中級的跳台、鐵桿與波浪道，是 Free Style 滑雪者的遊樂場。
    length: 2,500m
  - name: 15 SCHNEIDER
    difficulty: advanced
    note: 傳統意義上的雪場正門口。這裡設有大型綜合服務中心、滑雪學校，雪道寬敞且坡度適中，是所有人集合與初學者上課的核心基地。
    length: 1,500m
  - name: 18 UTOPIA-39°KABE
    difficulty: advanced
    note: 寬度非常充足的中高級紅道。這裡的特色是上段坡度稍陡，下段陡然變緩，適合用來練習在中高難度地形中的大弧度轉彎。
    length: 300m
  - name: 22 USHIKUBI
    difficulty: advanced
    note: 因地形險峻狹窄、兩側下切如牛脖子而得名。全線佈滿了因滑雪客反覆轉彎推擠出來的巨大天然饅頭，是全山公認最耗體力的硬派黑道。
    length: 1,200m
  - name: 23 KUROKURA
    difficulty: advanced
    note: 位於日影大本營邊緣的短程平緩通道，單純用來引導滑雪客滑向日影主要箱型纜車的排隊動線。
    length: 550m
  - name: 24 KANDAHAR-WEST
    difficulty: advanced
    note: 野澤溫泉引以為傲的地標。沿著高聳的山脊稜線一路下切 3.5 公里，兩側視野毫無遮蔽，能一邊全速滑行、一邊享受飛馳於群山之巔的極致視覺震撼。
    length: 990m
  - name: 25 KANDAHAR-EAST
    difficulty: advanced
    note: 紀念奧地利滑雪名將 Hannes Schneider 而命名。全線屬於坡度陡峭的硬質黑道，下坡衝擊力大，是中高級滑雪者檢視自己卡賓技術的指標雪道。
    length: 990m
  - name: 27 GRAND PRIX
    difficulty: advanced
    note: 隱藏在天際線下方山谷的舒適中級道。由於地形阻擋了強風，這裡的雪質經常能維持極度蓬鬆的狀態，滑行感如同踩在棉花上。
    length: 800m
  - name: 28 JUMPING
    difficulty: advanced
    note: 一條充滿古風名稱的林間捷徑。地形隨著山谷自然起伏，偶爾帶有小跳台感，適合喜歡邊滑邊尋找地形變化的探索型滑雪客。
    length: 500m
  - name: 31 HIKAGE-NO-KABE
    difficulty: advanced
    note: 連接長坂基地與柄澤基地之間的橫向林間綠道。沿途被茂密的針葉林包圍，坡度極其柔和，給人一種在雪中漫步的愜意感。
    length: 200m
  - name: 34 MUKOBAYASHI
    difficulty: advanced
    note: 藏匿在深山谷中的未整雪極限黑道。由於其特殊的碗狀地形，大雪過後這裡會累積極深的粉雪，是當地滑雪嚮導與野雪愛好者不願公開的深雪祕境。
    length: 200m
  - name: 36 HACHIMAN
    difficulty: advanced
    note: 從險峻的挑戰雪道底部引流出來的溫和綠道，主要讓挑戰完黑道的高手們能順暢地滑回長坂基地。
    length: 250m
lifts:
  total: 15
access:
...
terrainSummary:
  ...
  advanced: Schneider、Ushikubi、Kandahar、Grand Prix、Hikage-no-kabe 等路線集中在較陡或競技取向區域。

...
courses:
  ...
  - name: 9 UENOTAIRA-FAMILY
    difficulty: beginner
    length: 800m
    note: 位於上之平區域，官方家庭雪道頁將此區域列為適合初學者與家庭練習的寬緩坡面。
  - name: 10 PARADISE
    difficulty: beginner
    length: 1,200m
    note: 官方家庭雪道頁說明，上之平與 Paradise 一帶適合入門練習；若對下山滑行不熟，也可搭乘原本上山的 gondola 返回山麓。
  - name: 21 RINKAN
    difficulty: beginner
    length: 5,000m
    note: 官方總覽列出的最長滑走路線會經由 Paradise 接往林間路線，是從山頂一路銜接下山的長距離路線之一。
  - name: 29 HIKAGE-A
    difficulty: beginner
    length: 600m
    note: 官方家庭雪道頁說明，日影區是家庭與兒童較偏好的山麓區域，附近有 Kids Park、滑雪學校與租借店。
  - name: 32 ISEMIYA
    difficulty: beginner
    length: 300m
  - name: 33 NAGASAKA
    difficulty: beginner
    length: 700m
    note: 官方家庭雪道頁說明，長坂位於 P1 停車場旁，可直接接近雪道，並設有售票中心、洗手間、租借店、餐飲與接駁車站。
  - name: 35 KARASAWA
    difficulty: beginner
    length: 300m
    note: 官方家庭雪道頁說明，柄澤是三個山麓區域中位置最低的一處，鄰近 P2 停車場，並由 Karasawa Pair Lift 服務。

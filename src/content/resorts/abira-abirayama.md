...
contact:
  address:
    ...
    en: Hokkaido yuufutsu District abira, oiwaketoyosaka193banchi 059-1987
    googleMaps: https://maps.app.goo.gl/MQ8SsQtpqjY5dpuu5
  phone: 0145-25-2514
season:
  label: 2025-2026
  operatingPeriod: 2026/01/17-2026/02/23
  hours: 平日：9:00〜16:00 / 假日：9:00〜16:00
  note: 營業日期與時間會依積雪、天候與活動調整；出發前請確認官方公告。
  source: https://weathernews.jp/ski/spot/31801/
tickets:
  season: 2025-2026
  currency: JPY
...
courses:
  ...
  advancedRatio: 20
  courseInfoPage: https://www.town.abira.lg.jp/midokoro/shisetsu/sport/149
  summary: 安平町安平山官方列出初級者、林間、中級者、上級者與雪橇共 5 條路線，配置從親子雪遊、初級練習到進階坡面都有，並設有 1 座雙人纜車。
  details:
  - name: ソリコース
    difficulty: beginner
    note: 免費雪橇路線，適合不滑雪或還在熟悉雪地活動的小朋友與家庭使用。
  - name: 初級者コース
    difficulty: beginner
    note: 官方列出的初級者路線，作為剛開始練習滑行、煞車與基本轉彎的主要坡面。
  - name: 林間コース
    difficulty: intermediate
    note: 官方列出的林間路線，作為與一般開闊坡面不同的變化路線。
  - name: 中級者コース
    difficulty: intermediate
    note: 官方列出的中級者路線，適合已能穩定控制速度與轉彎後銜接滑行。
  - name: 上級者コース
    difficulty: advanced
    note: 官方列出的上級者路線，作為全場較高難度的滑行選擇。
lifts:
  total: 1
access:
  fromSapporo:

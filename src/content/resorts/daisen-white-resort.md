...
- label: 大山白色度假村雪道圖
  ...
  sourceLabel: Daisen White Resort Official
tickets:
  season: 2025-2026
  currency: JPY
...
courses:
  ...
  advancedRatio: 20
  courseInfoPage: https://www.daisen-resort.jp/4/13.html
  summary: 大山白色度假村由豪圓山、中之原、上之原與大山國際等 4 個區域構成，官方列出 9 條雪道，天氣好時可眺望日本海。
  details:
  - name: 豪円山エリア / Goenzan Area
    difficulty: beginner
    length: 550m
    maxSlope: 15°
    averageSlope: 6°
    note: 官方說明為平緩、寬廣且平坦的雪道，適合初學者與初級者練習；旁邊有兒童雪地區。
  - name: U1コース / U1 Course
    difficulty: beginner
    length: 410m
    maxSlope: 16°
    averageSlope: 10°
    note: 官方說明為初級到中級者取向，雪道寬度較寬，適合從豪円山區域進階後挑戰。
  - name: テクニクダス / Technicdas
    difficulty: beginner
    length: 1,400m
    maxSlope: 11°
    averageSlope: 10°
    note: 官方雪道表列出最大 11°、平均 10° 的緩坡長距離路線。
  - name: 中の原エリア / Nakanohara Area
    difficulty: intermediate
    length: 870m
    maxSlope: 27°
    averageSlope: 14°
    note: 官方說明為被山毛櫸林包圍的寬廣扇形斜面，越往上方越需要技術。
  - name: 国際エリア / International Area
    difficulty: intermediate
    length: 400m
    maxSlope: 12°
    averageSlope: 11°
    note: 官方說明可連接 Champion 下部，能享受較平緩的林間路線；2024-2025 雪季初級路線曾暫停使用，出發前請確認當季開放狀態。
  - name: パラダイス / Paradise
    difficulty: intermediate
    length: 900m
    maxSlope: 30°
    averageSlope: 15°
    note: 官方說明上部急斜面雪丘較難，中段為較容易滑行的一枚バーン，可作為 carving 與基本練習區。
  - name: U2コース / U2 Course
    difficulty: advanced
    length: 760m
    maxSlope: 27°
    averageSlope: 13°
    note: 官方說明為未壓雪區域，中央道路上側偏中上級者取向，也會作為競技者用 pole 練習斜面。
  - name: リーゼン / Riesen
    difficulty: advanced
    length: 1,000m
    maxSlope: 30°
    averageSlope: 15°
    note: 官方說明上部雪丘較具挑戰性，兩側林木接近，需要確實控制速度。
  - name: チャンピオン / Champion
    difficulty: advanced
    length: 1,600m
    maxSlope: 30°
    averageSlope: 14°
    note: 官方說明為此區最長路線，晴天時可感受像朝日本海滑下去的下坡感。
lifts:
  total: 10
access:
  fromOsaka:
  ...
  car:
    ...
    note: 可由米子自動車道米子 IC 往大山方向前往；雪季山路需準備雪胎或雪鏈，停車資訊請以官方公告為準。
terrainSummary:
...
大山白色度假村位於鳥取縣的大山山麓，氛圍偏輕鬆友善，適合把親子同行、練習與雪地遊玩排在一起。放進大山旅程時，能和周邊雪場形成不同節奏；適合親子同行或想用輕鬆節奏累積滑行經驗的人。滑行之外，也能把雪景、休息與地方氛圍一起留下來。

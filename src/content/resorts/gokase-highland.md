...
courses:
  ...
  - name: Beginner course
    difficulty: beginner
    note: 官方雪道頁介紹為初學者可利用的滑行區域，詳細長度與坡度待官方資料補齊。
  - name: Paradise Course
    difficulty: beginner
    note: 官方雪道頁列出的滑行區域之一，詳細難度、長度與坡度待官方資料補齊。
  - name: Dynamic Course
...
五瀨高原位於宮崎縣，想在一般滑行之外加入小跳、道具與節奏變化，這裡會更有玩味。比起匆忙踩點，更適合用半天到一天熟悉雪面、坡感與山景；適合同行者程度不同時，用比較不緊繃的方式共享雪地時間。整體適合放慢節奏，從雪面觸感、山景與停留氛圍中感受差異。

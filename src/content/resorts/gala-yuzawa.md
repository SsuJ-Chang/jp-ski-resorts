...
tickets:
  ...
  currency: JPY
  source: https://gala.co.jp/winter/charges/
  note: 主要票種依 2025-2026 公開資訊整理；線上購票價格通常較便宜，未滿 2 歲兒童免費，未就學兒童需有成人同行。
  plans:
  - name: 廂型纜車・纜車 1 日券
    audience: 大人、小學生
    price: 大人 ¥7,300（線上 ¥6,800）、小學生 ¥3,000（線上 ¥2,800）
    note: 可使用 GALA 湯澤站往返雪場的廂型纜車、場內纜車與 Yuzawa Snow Link 連絡纜車 Ropeway。
  - name: 廂型纜車・纜車 2 日券
    audience: 大人、小學生
    price: 大人 ¥12,000（線上 ¥11,000）、小學生 ¥4,500（線上 ¥4,300）
    note: 需連續 2 日使用。
  - name: 廂型纜車・纜車 4 小時券
    audience: 大人、小學生
    price: 大人 ¥6,500（線上 ¥6,000）、小學生 ¥2,400（線上 ¥2,200）
    note: 從首次通過閘門起 4 小時內有效，未使用完畢不可跨日。
  - name: 春季 1 日券
    audience: 大人、小學生
    price: 大人 ¥6,300（線上 ¥5,800）、小學生 ¥2,500（線上 ¥2,300）
    note: 春季營業期間使用。
  - name: 觀光廂型纜車來回券
    audience: 大人、小學生
    price: 大人 ¥3,500、小學生 ¥1,000
    note: 僅供觀光搭乘廂型纜車往返。
  - name: 觀光廂型纜車＋Barouche 觀光纜車券
    audience: 大人、小學生
    price: 大人 ¥5,000、小學生 ¥2,500
...
courses:
  ...
  details:
    - name: C1 メロディ / Melody
      ...
      length: 350m
      maxSlope: 12°
      note: 坡度與距離適合集中練習；直行可接到エーデルワイス下段的緩坡。
    - name: C2 エーデルワイス / Edelweiss
      difficulty: beginner
      length: 1,600m
      maxSlope: 10°
      note: 林間迂迴雪道，適合慢慢滑行；是中央區域的迂迴路線。
      videoLinks:
    ...
    - name: N9 下山コース ファルコン / Falcon
      ...
      videoLinks:
        ...
        - https://www.youtube.com/watch?v=U72zlDHe2F8&t=1269s
    ...
    - name: N3 スーパーブロードウェイ / Super Broadway
      ...
      length: 450m
      maxSlope: 26°
      note: 寬廣且坡度適中的雪道，降雪後可遇到粉雪；部分時段可能作為 pole lesson 使用。
    - name: N5/N6 ジョアンナ / Joanna
      difficulty: intermediate
      length: 250m
      maxSlope: 18°
    ...
    - name: N4 スーパースワン / Super Swan
      difficulty: expert
      length: 160m
      maxSlope: 33°
      note: 非壓雪雪道，降雪後可滑粉雪，也有自然 bumps；最大斜度 33°，屬 GALA 的高手向路線。
      videoLinks:
        - https://www.youtube.com/watch?v=IaD2DEbzV9o&t=1781s
lifts:
  total: 11
access:
  fromTokyo:
...
GALA湯澤位於新潟縣的湯澤雪國，地形公園與巡航斜面能放在同一天安排，滑行節奏比單純練習更有變化。放進湯澤旅程時，能和周邊雪場形成不同節奏；適合第一次日本滑雪時，把代表性雪景與滑行體驗放在一起。滑行之外，也能把雪景、休息與地方氛圍一起留下來。

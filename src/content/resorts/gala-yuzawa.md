...
- onsen
links:
  official: https://gala.co.jp/en/winter/
  trailMapPage: https://gala.co.jp/en/winter/course/
  ticket: https://gala.co.jp/en/winter/charges/
  access: https://gala.co.jp/en/winter/access/
...
season:
  label: 2025-2026
  operatingPeriod: 2025/12/20-2026/5/6
  hours: 請以官方營業時間公告為準
  note: 營業期間、時間與開放範圍會受積雪與天候影響，請以官方公告為準。
  source: https://gala.co.jp/en/winter/charges/
trailMaps:
- label: GALA湯澤雪場圖
  language: 日本語
  season: 2025-2026
  url: https://gala.co.jp/en/winter/course/
  sourceLabel: GALA Yuzawa Snow Resort
tickets:
  season: 2025-2026
  currency: JPY
  source: https://gala.co.jp/en/winter/charges/
...
snowWeather:
  ...
  - date: 1/2(五)
    ...
    low: 8°C
    high: 3°C
  note: 非即時資料，目前作為 UI 顯示用 placeholder；實際雪況請以官方雪況頁或 Weathernews 為準。
mapDisplay:
...
access:
  ...
  - label: 東京出發
    ...
    - label: GALA Yuzawa Snow Resort Access
      url: https://gala.co.jp/en/winter/access/
  car:
    recommended: false
    snowTireRequired: true
    note: 雪季自駕需準備雪胎或雪鏈；初次前往建議優先確認接駁與大眾運輸。
terrainSummary:
  beginner: 中央區域有較容易進入的練習與巡航路線。
  intermediate: 北區與中央區可串聯較長距離滑行。
  advanced: 南區有非壓雪與較陡路線。
  snowboard: 雙板與雪板皆可使用，詳細裝備規則依官網。
externalContent:
  blogs: []
  vlogs: []
sources:
- label: GALA Yuzawa Snow Resort Official Website
  url: https://gala.co.jp/en/winter/
- label: GALA Yuzawa Snow Resort Course / Trail Map
  url: https://gala.co.jp/en/winter/course/
- label: GALA Yuzawa Snow Resort Ticket
  url: https://gala.co.jp/en/winter/charges/
---
GALA湯澤位於越後湯澤周邊，最大特色是與新幹線車站直結，適合從東京安排一日滑雪或初次日本滑雪行程。

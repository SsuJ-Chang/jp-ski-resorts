...
season:
  ...
  hours: 平日：8:30〜16:00(日没迄) 休日：8:00〜16:00(日没迄) ナイター：なし
  note: Weathernews 2025-2026 營業期間摘要；實際開放日、營業時間與夜滑日請以官方公告為準。
  source: https://weathernews.jp/ski/spot/34201/
trailMaps:
- label: 川場 官方雪道資訊
  language: 日本語
  season: 2025-2026
...
courses:
  ...
  summary: Weathernews 列為 11 條雪道；本資料依官方雪道頁整理主要雪道，並以 Weathernews 難度比例作為總覽參考。
  details:
  - name: ファーストステップゲレンデ
    difficulty: beginner
    length: 51m
    maxSlope: 10°
    note: 短距離練習坡，官方定位為初次滑雪者的起步區。
  - name: 桜川コース
    difficulty: beginner
    length: 1,300m
    maxSlope: 16°
    note: 川場的主要緩坡路線，適合初級者銜接較長滑行。
  - name: クリスタルコース
    difficulty: beginner
    length: 2,000m
    maxSlope: 16°
    note: 從山頂側延伸的長距離緩坡，可享受較長巡航。
  - name: シャミンダウンヒル
    difficulty: intermediate
    length: 720m
    maxSlope: 24°
    note: 坡面變化較多，適合中級者練習節奏變化。
  - name: 白鳥スカイライン
    difficulty: intermediate
    note: 官方雪道圖列名路線，屬中級巡航動線。
  - name: 高手スカイライン
    difficulty: intermediate
    note: 官方雪道圖列名路線，主要作為中高段移動與巡航路線。
  - name: 西峰ダウンヒル
    difficulty: advanced
    note: 官方雪道圖列名下滑路線，坡度與速度感較高。
  - name: 白鳥ダウンヒル
    difficulty: advanced
    note: 官方雪道圖列名下滑路線，適合進階者。
  - name: 高手ダウンヒル
    difficulty: advanced
    note: 官方雪道圖列名下滑路線，銜接山麓方向。
  - name: 無名峰ダウンヒル
    difficulty: ungroomed
    length: 720m
    maxSlope: 26°
    note: 官方標示為較陡、非壓雪取向的下滑路線。
  - name: モーグルコース
    difficulty: advanced
    length: 638m
  ...
  advancedRatio: 20
terrainSummary:
  beginner: 初級雪道以 ファーストステップゲレンデ、桜川コース、クリスタルコース 為主，適合練習速度控制與穩定轉彎。
  intermediate: 中級者可用 シャミンダウンヒル、白鳥スカイライン、高手スカイライン 串接較長滑行或主坡巡航。
...
access:
  car:
    ...
    note: Weathernews 交通資訊摘要：上越線沼田駅からタクシー 電車 ：上越新幹線上毛高原駅から送迎バス(要予約)または、タクシー 車 ：前橋IC→沼田IC経由 (50分) 車 ：練馬IC→沼田IC経由 (150分) 1800台
      平日 無料 休日 立体駐車場に駐車の場合、1500円/1台
---
川場（川場スキー場）資料依官方雪道資訊與 Weathernews 2025-2026 雪場頁整理；實際開放雪道、票價與營業時間請以出發日前官方公告為準。

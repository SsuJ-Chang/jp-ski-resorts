...
- snowboard_friendly
links:
  official: https://www.chuo-alps.com/ski/
  weather: https://weathernews.jp/ski/spot/44806/
  access: https://www.chuo-alps.com/access/
...
courses:
  ...
  advancedRatio: 30
  courseInfoPage: https://www.chuo-alps.com/ski/
  summary: 官方列出千畳敷カールゲレンデコース與 3 條需登山裝備的 backcountry 路線；Tバーリフト設置會依積雪另行公告，出發前需確認。
  details:
  - name: 千畳敷カールゲレンデコース
    difficulty: mixed
    length: 約250m
    maxSlope: 25°
    averageSlope: 15°
    note: 千畳敷カール內春季滑雪區，官方構成為初級 40%、中級 30%、上級 30%。
  - name: 駒ヶ岳〜黒川コース
    difficulty: expert
    note: 官方 backcountry 路線，需冰爪與冰鎬等登山裝備，含木曽駒ヶ岳周邊滑降與回程上攀。
  - name: 伊那前岳架線沢コース
    difficulty: expert
    note: 官方 backcountry 路線，需登山裝備；架線沢下段變窄，需上攀返回。
  - name: 極楽平〜伊奈川源流コース
    difficulty: expert
    note: 官方 backcountry 路線，需登山裝備；極楽平上攀與回千畳敷路線需注意雪崩與雪況。
lifts:
  total: 1
access:
  fromTokyo:
    - label: "東京出發經駒ヶ根"
      steps:
        - "從新宿、東京方向搭 JR 或高速巴士到駒ヶ根站、駒ヶ根巴士總站周邊。"
        - "轉乘路線巴士到しらび平站。"
        - "從しらび平站搭中央阿爾卑斯駒ヶ岳 Ropeway 到千疊敷站。"
      estimatedTime: "駒ヶ根後約 60 分"
      difficulty: "hard"
      note: "一般車輛不能進入しらび平站與 Ropeway 山麓站；路線巴士、Ropeway 會受山岳天候與積雪影響，務必先確認運行狀況。"
  car:
    recommended: false
    snowTireRequired: true
    note: "自駕只能到菅の台巴士中心周邊停車，從駒ヶ根 IC 到菅の台約 3 分；之後需轉乘巴士約 30 分到しらび平，再搭 Ropeway 約 7.5 分。菅の台停車場約 300 台，普通車 1 天 800 日圓。"
terrainSummary:
...
中央阿爾卑斯千疊敷位於長野縣，位處高海拔雪域，適合把滑行、眺望與雪國空氣一起感受。降雪後的雪面變化會讓每一趟滑行有不同表情；適合同行者玩法不同時，依各自節奏安排滑行的人。整體適合放慢節奏，從雪面觸感、山景與停留氛圍中感受差異。

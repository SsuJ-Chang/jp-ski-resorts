...
tags:
  ...
  - snowboard_friendly
links:
  official: https://www.hachi-hachikita.co.jp/hachi/
  trailMapPage: https://www.hachi-hachikita.co.jp/hachi/slope.html
  ticket: https://www.hachi-hachikita.co.jp/hachi/rate.html
  access: https://www.hachi-hachikita.co.jp/hachi/access.html
  weather: https://weathernews.jp/ski/spot/36310/
  googleMaps: https://www.google.com/maps/search/?api=1&query=Hachi%20Kogen%20Ski%20Resort
contact:
  address:
...
tickets:
  ...
  plans:
    - name: 1 日券（平日）
      audience: 大人 / 長者 / 兒童
      price: 大人 ¥5,000、長者 ¥4,500、兒童 ¥3,500
      note: 長者為 60 歲以上且需出示年齡證明；兒童為 4 歲至小學 6 年級。
    - name: 1 日券（假日）
      audience: 大人 / 兒童
      price: 大人 ¥5,500、兒童 ¥3,500
    ...
    - name: 季票
      audience: 大人 / 長者 / 兒童
      price: 大人 ¥57,000、長者 ¥54,000、兒童 ¥32,500
...
courses:
  ...
  advancedRatio: 10
  courseInfoPage: https://www.hachi-hachikita.co.jp/hachi/slope.html
  summary: HACHI 高原以中央雪場、林間長滑路與鉢伏山頂連絡路線為主，官方課程頁列出 11 條主要滑走路線，另有 THE PARKS、Snow Land 與 Kids Park 等雪上設施。
  details:
    - name: 中央ゲレンデペアコース
      difficulty: beginner
      note: 官方說明為配置多樣項目的大型 snow park 區，從初學者到上級者都能利用；課程狀況表標示為初級。
    - name: 中央ゲレンデクワッドコース
      difficulty: beginner
      note: 搭配慢速上下車的 4 人座纜車，坡面寬廣且平緩，官方說明適合小朋友與初學者安心滑行。
    - name: ファミリーゲレンデ
      difficulty: beginner
      note: 坡度溫和，搭配速度較慢的 3 人座纜車，官方說明適合兒童、初學者與練習升級。
    - name: ハチ林間コース
      difficulty: beginner
      note: 從中央雪場往山麓延伸、穿過樹林的緩和長滑路線，官方描述可在林間悠閒滑行。
    - name: 千石平コース
      difficulty: beginner
      note: 官方說明此線從高丸山滑入中央雪場，屬坡度平緩的初級連接型雪道。
    - name: ハチハイランドコース
      difficulty: beginner
      note: 接續千石平コース的短距離斜面，官方說明坡度適中、可舒服轉彎。
    - name: 大久保ゲレンデ
      difficulty: beginner
      note: 鄰近大久保民宿街，官方說明交通便利，適合作為暖身滑行區。
    - name: 中央ゲレンデトリプルコース
      difficulty: intermediate
      note: 官方說明具備適合 carving 與大轉彎的坡度與寬度，可一邊眺望寬闊雪場一邊滑行。
    - name: ダウンヒルコース
      difficulty: intermediate
      note: 通過安靜谷線的長滑路線，官方描述可感受自然，也可能遇見野鳥或小動物。
    - name: ハイランドビューエリア
      difficulty: advanced
      note: 從鉢伏山頂滑入 HACHI 高原的上級區域，官方說明僅在積雪充足時開放，降雪後可享受粉雪。
    - name: スーパースターエリア
      difficulty: advanced
      note: 從高丸山頂出發，官方說明雪質、坡度與距離都有挑戰性，且必須積雪充足才會開放。
lifts:
  total: 11
access:
  fromOsaka:
...
sources:
  ...
  - label: Hachi Weathernews
    url: https://weathernews.jp/ski/spot/36310/
---
HACHI 高原位在兵庫縣北部鉢伏山南側，是 HACHI・HACHI 北共通券涵蓋的其中一區。雪場以中央雪場、林間長滑路線、親子雪上設施與山頂連絡區域構成，適合從大阪或神戶安排自駕，也可由 JR 八鹿站轉乘巴士前往。

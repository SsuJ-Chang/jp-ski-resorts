...
- tree_run
editorial:
  rjOpinion: 大推！作者 RJ 第一次到日本滑雪的雪場，體驗非常好，最下面的「鐘の鳴る丘ゲレンデ」實在是太新手友善了，又寬又緩。最大的缺點就是地點位在白馬 Valley 比較遠的地方，因為從八方車站或是從白馬五龍 ESCAL PLAZA 轉車都要搭比較久。有自駕或者住這附近會比較便利。
links:
...
courses:
  ...
  - name: 鐘の鳴る丘ゲレンデ / Kane-no-naruoka Slope
    ...
    maxSlope: 19°
    averageSlope: 8°
    note: 位於雪場最山麓、通稱「カネナル」的雪道。官方說明雪道寬度超過 1,200m，寬廣且坡度平緩，適合初學者與家庭。
  - name: からまつゲレンデ / 親の原ゲレンデ
    difficulty: beginner
    length: 1,200m
    maxSlope: 10°
    averageSlope: 7°
    note: 沿著 Karamatsu 高速 pair 纜車與 Tsugaike 中央 triple chair 纜車展開的緩斜面。官方說明只要能做 plow turn，就能享受超過 1,000m 的長距離滑行。
  - name: 御殿場コース / Gotenba Course
    difficulty: beginner
    length: 1,100m
    maxSlope: 30°
    averageSlope: 12°
    note: 從栂之森雪道旁、通過 Tsuga 第 2 pair 纜車下方後開始的林間路線。官方說明初級者也可滑行，但因地形起伏豐富，也受上級者歡迎。
  - name: 栂の森ゲレンデ / Tsuganomori Slope
  ...
  - name: 白樺ゲレンデ / Shirakaba Slope
    ...
    maxSlope: 23°
    averageSlope: 16°
    note: 官方說明為中級者最受歡迎的雪道，雪面整備且雪丘較少，平均斜度 16°，也是 FIS Super G 公認路線。
  - name: 丸山ゲレンデ / Maruyama Slope
    difficulty: intermediate
    length: 700m
    maxSlope: 15°
    averageSlope: 12°
    note: 與其他雪道相對獨立的一枚バーン。官方說明雪丘較少、平均斜度 12°，適合想掌握 parallel turn 或提升程度的團體課程。
  - name: ハンの木ゲレンデ / Hannoki Slope
    difficulty: intermediate
    length: 3,000m
    maxSlope: 30°
    averageSlope: 12°
    note: 全長約 3km 的長距離路線，官方說明初學者到上級者都可享受；路線直線但坡度有變化，部分區域有雪丘，上部在 5 月連休也可滑行。
  - name: チャンピオンゲレンデ / Champion Slope
    difficulty: advanced
    length: 1,000m
    maxSlope: 35°
    averageSlope: 26°
    note: 官方說明平均斜度 26°，雖然具有挑戰性，但因為是一片寬幅斜面，不會讓人過度感到速度壓迫；初級者也可改走林間路線慢慢滑行。
  - name: 馬の背コース / Umanose Course
    difficulty: advanced
    length: 1,300m
    maxSlope: 32°
    averageSlope: 17°

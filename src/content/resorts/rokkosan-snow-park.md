...
courses:
  ...
  - name: 第1ゲレンデ
    difficulty: beginner
    length: 260m
    note: 官方標示最大長度 260m、寬 50m 的初級坡。
  - name: 第2ゲレンデ
    difficulty: beginner
    length: 260m
    note: 官方標示最大長度 260m、寬 30m 的滑雪坡。
  - name: スノーランド
    difficulty: beginner
...
六甲山 Snow Park位於兵庫縣，重點不在刺激挑戰，而是讓同行者用舒服節奏熟悉雪地活動。行程可以安排得單純一點，把時間留給練習、休息與看雪景；適合把基礎練習、雪地遊玩與休息時間安排得更從容。停留時間可依練習、休息與雪景體驗彈性安排，不必把一天排得太緊。

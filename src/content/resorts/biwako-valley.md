...
contact:
  address:
    zhTw: 〒520-0514 滋賀縣大津市木戸1547-1
    ja: 〒520-0514 滋賀県大津市木戸1547-1
    en: 1547-1 Kido, Ootsu, Shiga 520-0514
    googleMaps: https://maps.app.goo.gl/KHBwaoxJVTDNEe3PA
  phone: 077-592-1155
season:
  label: 2025-2026
...
snowWeather:
  ...
  url: https://weathernews.jp/ski/spot/36001/
  snowDepth: 0 cm
...
courses:
  ...
  - name: 打見雪道
    ...
    maxSlope: 12°
    averageSlope: 6°
    note: 坡度平緩，鄰近纜車山頂站，適合初學者與兒童練習；滑行時需使用雪具。
  - name: 蓬萊全景雪道
    difficulty: intermediate
    length: 600m
    maxSlope: 20°
    averageSlope: 10°
    note: 可眺望琵琶湖的寬廣單一雪面，官方標示為中級雪道。
  - name: 巨人雪道
    difficulty: intermediate
    length: 1,000m
    maxSlope: 25°
    averageSlope: 12°
    note: 通過前段緩坡後，中央區域有具代表性的急坡，受到中上級滑雪者喜愛。
  - name: 浪漫雪道
    difficulty: intermediate
    length: 1,000m
    maxSlope: 22°
    averageSlope: 11°
    note: 以雪道前段的大彎道為特色；天然降雪後，雪道側邊可享受粉雪。
  - name: 阿爾卑斯雪道
    difficulty: beginner
    length: 1,000m
    maxSlope: 15°
    averageSlope: 9°
    note: 位於雪場中央，可由打見雪道不間斷滑入，並設有適合地形遊玩的雪道邊坡。
  - name: 動態雪道
    difficulty: intermediate
    length: 1,000m
    maxSlope: 22°
    averageSlope: 11°
    note: 林間雪道，具有由地形形成的自然波浪。
  - name: 冠軍雪道
    difficulty: advanced
    length: 1,400m
    maxSlope: 28°
    averageSlope: 12°
    note: 琵琶湖山谷最長雪道；因坡面較難附著積雪，營業期間可能較短。
  - name: 蓬萊北雪道
    difficulty: advanced
    length: 600m
    maxSlope: 30°
    averageSlope: 17°
    note: 官方標示為中上級雪道，下方寬廣雪面容易形成天然雪丘。
  - name: 森林雪道
    difficulty: intermediate
    length: 1,000m
    maxSlope: 19°
...
access:
  fromOsaka:
  - label: 大阪／京都搭乘 JR 與路線巴士
    steps:
    - 從 JR 大阪站前往京都站；搭乘新快速的旅客，需在京都站轉乘普通列車。
    - 從 JR 京都站搭乘湖西線，於 JR 志賀站下車，無需轉乘。
    - 從 JR 志賀站搭乘江若交通路線巴士，於終點「びわ湖バレイ前」下車，車程約 10 分鐘。
    difficulty: easy
    note: 志賀站是普通列車停靠站；巴士與電車班次請於出發前確認。
    links:
    - label: 官方交通與停車資訊

...
season:
  ...
  hours: 平日：8:00〜17:00 （週二定休） 假日：8:00〜17:00 夜滑：17:00〜21:00
...
tickets:
  ...
  - name: 4時間券（平日）
    price: 成人 ¥5,400 兒童 ¥3,500
  - name: 9時間券（週末及國定假日）
    price: 成人 ¥6,800 兒童 ¥4,300
  - name: 4時間券（週末及國定假日）
    price: 成人 ¥5,800 兒童 ¥3,500
  - name: シーズン券ゴールドメンバー
    price: 成人 ¥80,000 兒童 ¥45,000 樂齡 ¥68,000
  - name: 平日ゴゴイチ(13:00〜17:00）
    price: 成人 ¥3,800 ・上記リフト料金は入場料込みの価格です。・そり遊びなどは入場料¥600が必要です。・平日ゴゴイチ券は年末年始期間はご利用になれません。
elevation:
  top: 1066
  bottom: 972
  verticalDrop: 94
...
女鹿平溫泉 Megahira位於廣島縣，夜滑讓白天之外多一層雪場表情，短天數旅程也能拉出不同節奏。林間段落與自然地形能增加滑行層次，不只是在寬坡巡航；適合想把滑雪後的泡湯、在地停留與雪國慢節奏放進同一天的人。

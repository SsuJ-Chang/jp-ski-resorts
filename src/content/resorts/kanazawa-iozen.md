...
season:
  label: 2025-2026
  operatingPeriod: 12 月下旬至 3 月上旬，依積雪狀況調整
  hours: 8:30-16:30，天候不佳時可能縮短
  note: 官方公告令和 7 年度營業已結束；且因大雨受災與設備不良，Dynamic、Challenge、林道雪道與部分雪盆區自令和 7 年度起暫停開放，Family 雪坡正常營業。
  source: https://www.kanazawa-sports.jp/use/search/546
trailMaps:
- label: 金澤市營醫王山雪道與設施資訊
  language: 日本語
  season: 2025-2026
  url: https://www.kanazawa-sports.jp/use/search/546
  sourceLabel: かなざわスポーツねっと
tickets:
  season: 2025-2026
  currency: JPY
  source: https://www.kanazawa-sports.jp/use/search/546
...
courses:
  ...
  - name: ファミリーゲレンデ / Family Gelande
    ...
    length: 241m
    averageSlope: 約 10°
    note: 官方說明為坡度平緩、適合初學者與初級者練習，雪板可滑。
  - name: 林道コース / Rindo Course
    difficulty: beginner
    length: 2,000m
    averageSlope: 約 10°
    note: 官方列為初級者向路線；自令和 7 年度起暫停開放，出發前請確認官方公告。
  - name: ダイナミックコース / Dynamic Course
    difficulty: intermediate
    length: 520m
    maxSlope: 32°
    averageSlope: 17°
    note: 官方列為中、進階者向路線；自令和 7 年度起暫停開放，出發前請確認官方公告。
  - name: チャレンジコース / Challenge Course
    difficulty: advanced
    length: 500m
    maxSlope: 37°
    averageSlope: 21°
    note: 官方列為未壓雪、進階者向路線；自令和 7 年度起暫停開放，出發前請確認官方公告。
lifts:
  total: 2
access:
  fromTokyo:
  ...
  car:
    ...
    note: 官方列出金澤站開車約 30 分，也可由金澤站東口搭北鐵巴士醫王山線至「医王山スキー場前」下車步行約 1 分；冬季仍需確認班次與道路狀況。
terrainSummary:
  beginner: Family 雪坡與初學者練習區是目前主要使用區，適合金澤近郊入門滑雪。
...
金澤市營醫王山位於石川縣，氛圍偏輕鬆友善，適合把親子同行、練習與雪地遊玩排在一起。節奏不必排得太滿，反而能慢慢感受雪面、空氣與山景變化；適合親子同行或想用輕鬆節奏累積滑行經驗的人。滑行之外，也能把雪景、休息與地方氛圍一起留下來。

...
courses:
  ...
  - name: センターコース
    ...
    length: 350m
    maxSlope: 8°
    note: 位於 Center Lift 旁的初級雪道，坡度較緩，適合初學者進入一般雪道前練習。
  - name: 登山道コース
    difficulty: intermediate
    length: 1,000m
    maxSlope: 12°
    note: 官方雪場圖標示為中級斜面，是從上部往山麓迂迴下滑的長距離路線。
  - name: スパルタコース
    difficulty: intermediate
    length: 600m
    maxSlope: 20°
    note: 官方雪場圖標示為中級斜面，坡度比其他中級路線更明顯。
  - name: ブラッキーコース
    difficulty: intermediate
    length: 900m
    maxSlope: 13°
    note: 沿 Blacky Lift 一帶下滑的中級斜面，可銜接山麓主要設施。
  - name: グリーンコース
    difficulty: advanced
    length: 700m
    maxSlope: 13°
    note: 官方雪場圖標示為上級斜面，位於 Green Lift 側。
  - name: スラロームバーン
    difficulty: advanced
    length: 800m
    maxSlope: 13°
...
access:
  ...
  car:
    ...
    note: 從旭川市中心開車約 15 分鐘，從旭川鷹栖 I.C. 開車約 15 分鐘；停車場約 1,500 台，平日與假日皆免費，雪季自駕需準備雪胎或雪鏈。
terrainSummary:
...
旭川聖誕禮物公園位於北海道，特色不只在巡航，也能把跳台、箱型道具或公園元素排進滑行節奏。降雪後的雪面變化會讓每一趟滑行有不同表情；適合把基礎練習、雪地遊玩與休息時間安排得更從容。停留時間可依練習、休息與雪景體驗彈性安排，不必把一天排得太緊。

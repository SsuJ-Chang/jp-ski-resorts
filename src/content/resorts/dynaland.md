...
contact:
  address:
    zhTw: 〒501-5305 岐阜縣郡上市高鷲町西洞 3035-2
...
courses:
  ...
  - name: パラダイスAコース / Paradise A Course
    ...
    maxSlope: 24°
    averageSlope: 11°
    note: 緩坡可一路延伸到山麓，course side 有地形可玩，也是 Paradise Tree Run 入口之一。
  - name: 乙女コース / Otome Course
    difficulty: beginner
    length: 1,000m
    maxSlope: 16°
    averageSlope: 13°
    note: 坡面本身較緩，但內含 Re Terrain Park、mogul、tree run 等技術區域。
  - name: 神中Aコース / Kamichu A Course
    difficulty: beginner
    length: 2,600m
    maxSlope: 28°
    averageSlope: 13°
    note: 官方列為初級，但雪質與坡面變化較明顯，也可通往 Karamatsu、Baboon 與高鷲連絡動線。
  - name: 第1ゲレンデ / No.1 Gelende
    difficulty: beginner
    length: 650m
    maxSlope: 22°
    averageSlope: 10°
    note: 從 center house 搭一支 lift 可到的初級區，也可連到 Step Up Park。
  - name: から松ゲレンデ / Karamatsu Gelende
    difficulty: beginner
    length: 420m
    maxSlope: 15°
    averageSlope: 11°
    note: 寬廣緩坡，官方稱為 Dynaland 三大初級 course 之一，適合反覆練習。
  - name: 第6ゲレンデ / No.6 Gelende
    difficulty: beginner
    length: 400m
    maxSlope: 15°
    averageSlope: 12°
    note: 連接多條上方 course 出口，寬廣且視野好。
  - name: β-α山頂連絡コース / Beta-Alpha Summit Connection
    difficulty: beginner
    length: 600m
    maxSlope: 11°
    averageSlope: 10°
    note: 連接 Beta Liner 與 Alpha Liner 山頂，可接入 Paradise A 組成長距離滑行。
  - name: ラビットコース / Rabbit Course
    difficulty: beginner
    length: 500m
    maxSlope: 15°
    averageSlope: 8°
    note: 從 Skyline A 迂迴到 Kamichu A 的救援路線，雪質好時也是隱藏練習線。
  - name: モーグルコース / Mogul Course
    difficulty: intermediate
    length: 200m
    maxSlope: 20°
    averageSlope: 18°
    note: 200m 三線並排的 mogul course，官方建議以 Gamma Liner 周回。
  - name: ダウンヒルコース / Downhill Course
    difficulty: intermediate
    length: 2,500m
    maxSlope: 24°
    averageSlope: 15°
    note: Dynaland 主幹 course，早朝營業與夜滑也會開放，從 peak 一路滑回 base。
  - name: パラダイスBコース / Paradise B Course
    difficulty: intermediate
    length: 730m
    maxSlope: 25°
    averageSlope: 17°
    note: 從 Alpha / Gamma 下車點接回 Paradise A 的短線，急緩、粉雪與地形變化明確。
  - name: スカイラインBコース / Skyline B Course
    difficulty: intermediate
    length: 2,400m
    maxSlope: 28°
    averageSlope: 17°
    note: 官方說明可用於比賽與檢定，適合長距離 carving 轉彎。
  - name: クマダナコース / Kumadana Course
    difficulty: intermediate
    length: 400m
    maxSlope: 16°
    averageSlope: 12°
    note: 從 Rabbit Course 進入，曾作為 tree run 開放，現在以林間感與 bank 變化為特色。
  - name: 神中Bコース / Kamichu B Course
    difficulty: advanced
    length: 700m
    maxSlope: 30°
    averageSlope: 20°
    note: 從 Downhill Course 進入的上級線，饅頭與降雪後粉雪是官方重點描述。
  - name: 神中回転バーン / Kamichu Rotation Barn
    difficulty: advanced
    length: 600m
    maxSlope: 34°
    averageSlope: 22°
    note: 與 Kamichu B 相鄰，坡寬較窄且最大斜度更高。
  - name: チャレンジBコース / Challenge B Course
    difficulty: advanced
    length: 610m
    maxSlope: 38°
    averageSlope: 27°
    note: Dynaland 最難關之一，最大 38°，官方說明壓雪車無法進入，為硬派 course。
  - name: チャレンジCコース / Challenge C Course
    difficulty: advanced
    length: 780m
    maxSlope: 32°
    averageSlope: 22°
    note: Challenge B 旁的高難度線，從 Beta Liner 可進入。
  - name: スカイラインAコース / Skyline A Course
    difficulty: advanced
    length: 2,200m
    maxSlope: 31°
    averageSlope: 18°

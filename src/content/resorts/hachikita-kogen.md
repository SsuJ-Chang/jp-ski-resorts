...
tags:
  ...
  - tree_run
links:
  official: https://www.hachi-hachikita.co.jp/hachikita/
  trailMapPage: https://www.hachi-hachikita.co.jp/hachikita/slope.html
...
trailMaps:
  - label: HACHI 北高原官方雪場・課程頁
    ...
    sourceLabel: Hachikita Official
tickets:
  season: 2025-2026
  currency: JPY
  source: https://www.hachi-hachikita.co.jp/hachikita/rate.html
...
courses:
  ...
  details:
    - name: パノラマゲレンデ
      difficulty: beginner
      note: 位於鉢伏山頂的北向斜面，官方說明雪況穩定、開放期間較長，適合享受高處景觀與巡航滑行。
    - name: 野間ゲレンデ
      difficulty: beginner
      note: 位在中央停車場與登行纜車旁，官方說明為初學者與雪上遊樂容易利用的區域。
    - name: ファミリーゲレンデ
      difficulty: beginner
      note: 坡度平緩，可依照個人速度慢慢練習，官方說明適合初學者與親子使用。
    - name: スカイロード（下部）
      difficulty: beginner
      note: 山麓側的寬廣斜面，官方說明可用來銜接長滑路線，也適合基礎練習。
    - name: スカイロード（上部）
      difficulty: intermediate
      note: 官方說明為從山頂開始、長度約 800m 的路線，雪質良好並可享受高原景觀。
    - name: 樹氷コース
      difficulty: intermediate
      note: 通過冬季樹冰景觀的路線，官方說明可在自然景色中滑行。
    - name: チャレンジ迂回コース
      difficulty: intermediate
      note: 穿越山毛櫸林間的窄路，官方說明可繞開 Challenge Course 並回到主要路線。
    - name: ハチ北中央ゲレンデ
      difficulty: intermediate
      note: 官方說明每天早晨壓雪整理，坡度舒適，適合練習轉彎與穩定滑行。
    - name: アルペン林間コース
      difficulty: intermediate
      note: 沿 Alpen Course 旁的林間路線，官方說明可在樹林間滑行並回到山麓。
    - name: 山麓林間コース
      difficulty: intermediate
      note: 從山麓穿過山毛櫸林的緩和路線，官方說明適合穩定地返回 Base 區。
    - name: ネイチャーゾーン
      difficulty: advanced
      note: 官方說明保留自然地形與木立，屬於可感受原始雪面變化的區域，需依規則與現場開放狀況利用。
    - name: アルペンコース
      difficulty: advanced
      note: 從高丸山展開、利用自然地形起伏的路線，官方說明可享受變化感明顯的滑行。
    - name: チャレンジコース
      difficulty: advanced
...
access:
  fromOsaka:
    - label: 大阪自駕
      steps:
        - 從中國道吉川 JCT 接舞鶴若狹道春日 IC，再轉北近畿豐岡道。
  ...
  car:
    ...
    note: 雪場位於鉢伏山北側山區，冬季自駕需準備雪胎或鏈條；共通券可往來 HACHI 的條件仍取決於山頂積雪與天候。
terrainSummary:

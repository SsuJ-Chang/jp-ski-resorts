...
prefecture: 滋賀縣
location:
  latitude: 35.49670493535472
  longitude: 136.03238392569844
elevation:
  top: 350
  bottom: 150
  verticalDrop: 200
...
season:
  ...
  note: 2025-2026 雪季已結束。
  source: https://makinokougen.co.jp/pages/275/
trailMaps:
- label: 牧野高原 Family 官方雪道資訊
  language: 日本語
  season: 2025-2026
  url: https://makinokougen.co.jp/pages/275/
...
access:
  ...
  - label: JR 湖西線牧野站轉乘城鎮巴士
    ...
    links:
    - label: 牧野高原官方交通資訊
      url: https://makinokougen.co.jp/pages/2/
  car:
    recommended: true
    snowTireRequired: true
    note: 京都東 IC 經西大津繞道、湖西道路與國道 161 號約 80 分鐘；木之本 IC 經國道 8 號、303 號約 30 分鐘；敦賀 IC 經國道 8 號、161 號約 40 分鐘。停車場可容納 500 台，普通車 ¥1,000／台、中型車（小巴）¥2,000／台、大型車（觀光巴士）¥3,000／台；不可重新進場，場內請依指示單向行駛。
terrainSummary:
  beginner: 初級雪道以 ファミリーゲレンデ 為主，適合練習速度控制與穩定轉彎。
  snowboard: 雪板可全區滑行；park、非壓雪與管制區仍以現場公告為準。

sources:
  - https://makinokougen.co.jp/pages/275/
  - https://makinokougen.co.jp/pages/2/

---

牧野高原 Family 位於滋賀縣，設有適合初學者的家庭雪場與約 100 公尺的 SunKid 動態步道。除了滑雪與滑雪板，也提供香蕉船巡迴、雪鞋健行等雪上活動；整體規模小巧，適合親子同行與初次接觸雪上運動。

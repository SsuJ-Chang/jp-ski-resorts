...
links:
  ...
  trailMapPage: https://nikkoyumoto-ski.com/guide.html#course
...
courses:
  ...
  - name: A コース
    difficulty: beginner
    note: 穿過樹林的緩坡路線，官方介紹適合初級者慢慢滑。
  - name: B コース
    difficulty: beginner
    note: 由第 3、第 5 pair lift 可抵達的緩坡，適合基礎練習。
  - name: C コース
    difficulty: beginner
    note: 坡面溫和，官方說明也適合 snowboard 課程與練習。
  - name: D コース
    difficulty: intermediate
    note: 官方建議在熟悉初級坡後挑戰，作為中級入門路線。
  beginnerRatio: 70
...
日光湯元溫泉位於栃木縣，高海拔帶來清爽雪質與開闊視野，山岳景觀會成為滑行之外的亮點。節奏不必排得太滿，反而能慢慢感受雪面、空氣與山景變化；適合親子同行或想用輕鬆節奏累積滑行經驗的人。滑行之外，也能把雪景、休息與地方氛圍一起留下來。

...
name:
  zhTw: 戶隱
  ja: 戸隠スキー場
  en: Togakushi Ski Area
region: kanto-koshinetsu
prefecture: 長野縣
location:
  latitude: 36.754520026427315
  longitude: 138.094631
elevation:
  top: 1748
  bottom: 1220
tags:
  ...
  - snowboard_friendly
links:
  official: https://www.togakusi.com/ski/
  weather: https://weathernews.jp/ski/spot/34806/
  googleMaps: https://maps.app.goo.gl/1bXS7oy5Uzrxyzry5
  trailMapPage: https://www.togakusi.com/ski/course/
  ticket: https://www.togakusi.com/ski/charge/
...
season:
  label: 2026-2027
  hours: 8:30〜16:15
  note: 2026-2027 雪季票價已公開，營業期間與實際開放範圍仍以官方公告為準。
  source: https://www.togakusi.com/ski/charge/
trailMaps:
  - label: 戶隱雪道圖
    language: 日本語
    season: 2026-2027
    url: https://www.togakusi.com/data/gelandemap_2022.pdf
    sourceLabel: Togakushi Ski Area Official
tickets:
  season: 2026-2027
  currency: JPY
  source: https://www.togakusi.com/ski/charge/
...
courses:
  ...
  summary: 19 條雪道從親子緩坡到高坡挑戰都齊備，山頂可眺望戶隱連峰與北阿爾卑斯。整體以粉雪感與長距離巡航見長，另有岩戶旗門專用區域與兒童樂園。
  details:
    ...
    - name: パラダイスコース
      ...
      maxSlope: 22°
      averageSlope: 20°
      note: 中社側的上級路線，雪面狀態通常較有變化。
    - name: フレッシュコース
      difficulty: advanced
      length: 1,100m
      maxSlope: 29°
      averageSlope: 23°
      note: 中社側上級路線，側坡與連續變化感明顯。
    - name: グランドコース
      difficulty: advanced
      length: 950m
      maxSlope: 28°
...
access:
  fromTokyo:
    - label: 東京出發
      steps:
        - 東京站搭乘北陸新幹線至長野站。
        - 轉乘戶隱線巴士前往雪場；冬季也可搭配官方巴士套票規劃。
      estimatedTime: 約 3 小時
      difficulty: medium
      note: 長野市內到雪場約 40 分鐘；東京出發時間會因新幹線與轉乘等待而拉長。
      links:
        - label: Togakushi Access
          url: https://www.togakusi.com/ski/access/
  publicTransit:
    - label: 長野站轉乘
      steps:
        - 在長野站東口搭乘前往戶隱方向的巴士。
      ...
      difficulty: medium
      note: 以長野站為主要轉乘點，冬季班次與接駁安排會影響整體時間。
      links:
        - label: Togakushi Access
          url: https://www.togakusi.com/ski/access/
  car:
    ...
    note: 官方建議從信濃町IC進入；往長野市側可利用浅川ループライン。冬季道路需準備雪胎或雪鏈，停車場為免費。
terrainSummary:
  beginner: 初級雪道約 30%，適合暖身、基礎練習與親子滑行。
  intermediate: 中級雪道約 40%，長距離巡航與連續轉彎空間都足夠。
  advanced: 高級雪道約 30%，有陡坡、未壓雪與節奏變化明顯的路線。
  snowboard: 全區可滑單板；另有 freestyle park、兒童區與旗門專用區域。
---

戶隱是能直接看見戶隱連峰與北阿爾卑斯的高海拔雪場，19 條雪道從親子緩坡到高坡挑戰都齊備。長距離巡航、粉雪感與開闊山景是最大特色，另有適合初學者與家庭的區域。

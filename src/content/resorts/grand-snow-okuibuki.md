...
courses:
  ...
  - name: 兒童公園
    ...
    maxSlope: 8°
    averageSlope: 8°
    note: 設有兒童活動空間，適合親子雪上遊戲與初次接觸雪地活動的遊客。
  - name: 初學者雪場
    difficulty: beginner
    length: 200m
    maxSlope: 10°
    averageSlope: 10°
    note: 設有綠色隧道與雪地電扶梯，適合第一次滑雪或單板滑雪的練習者。
  - name: 家庭雪場
    difficulty: beginner
    length: 400m
    maxSlope: 13°
    averageSlope: 10°
    note: 雪場內坡度最平緩的區域，鄰近餐廳，適合初學者與家庭客。
  - name: 多樣雪場
    difficulty: intermediate
    length: 900m
    maxSlope: 20°
    averageSlope: 13°
    note: 寬廣單一雪面，中段設有 Snow Park，可享受多樣滑行方式。
  - name: Paradise 雪場
    difficulty: intermediate
    length: 650m
    maxSlope: 18°
    averageSlope: 13°
    note: 雪場內相當熱鬧的家庭取向路線，縱向配置的緩坡適合持續滑行。
  - name: Technical 雪道
    difficulty: intermediate
    length: 700m
    maxSlope: 27°
    averageSlope: 24°
    note: 從雪場基地搭乘一條纜車即可進入，設有常設旗門滑道。
  - name: Dynamic 雪道
    difficulty: intermediate
    length: 600m
    maxSlope: 25°
    averageSlope: 23°
    note: 山間地形變化豐富，曾作為比賽場地使用，適合享受連續坡面變化。
  - name: Alpen 雪道
    difficulty: intermediate
    length: 600m
    maxSlope: 25°
    averageSlope: 18°
    note: 利用自然地形的山間雪道，也可作為挑戰雪道與 Dynamic 雪道的迂迴路線。
  - name: Challenge 雪道
    difficulty: intermediate
    length: 350m
    maxSlope: 30°
    averageSlope: 25°
    note: 短而有挑戰性的壓雪雪道，官方標示為場內少數可體驗超過 30° 坡度的路線。
  - name: 天狗岩雪道
    difficulty: intermediate
    length: 900m
    maxSlope: 30°
    averageSlope: 22°
    note: 可眺望琵琶湖與北阿爾卑斯山脈，上段為雪丘坡面，下段為壓雪雪面。
  - name: Sky View 雪道
    difficulty: intermediate
    length: 300m
    maxSlope: 20°
    averageSlope: 13°
    note: 穿越山毛櫸原生林的安靜雪道，降雪後可欣賞樹冰景色。
  - name: Mont Blanc 雪道
    difficulty: advanced
    length: 500m
    maxSlope: 30°
    averageSlope: 25°
    note: 保留未壓雪狀態的高級雪道，降雪後可享受粉雪滑行。
  - name: Champion 雪道
    difficulty: advanced
    length: 500m
    maxSlope: 33°
    averageSlope: 30°
    note: 關西知名 mogul 雪道，連續的高難度雪丘是其主要特色。
  - name: Heavenly 46°
    difficulty: advanced
    length: 400m
    maxSlope: 46°

...
contact:
  address:
    ...
    en: Gifu District ue, takasu, nishibora3086-1 501-5305
    googleMaps: https://maps.app.goo.gl/FLSpyawcH3hfDueq9
  phone: 0575-72-7000
season:
  label: 2025-2026
  operatingPeriod: 2025/12/6-2026/4/26，實際依積雪與官方公告調整
  hours: 全日 8:00-16:30
...
- label: 高鷲滑雪公園 / Dynaland 雪場圖
  ...
  sourceLabel: Takasu Snow Park Official
tickets:
  season: 2025-2026
  currency: JPY
...
courses:
  ...
  - name: バンブーコース / Bamboo Course
    ...
    maxSlope: 10°
    averageSlope: 7°
    note: 以迂迴避開急斜面為主，接上 Beginners Course 可形成全長 4,900m 的長距離滑行。
  - name: ビギナーズコース / Beginners Course
    difficulty: beginner
    length: 1,800m
    maxSlope: 13°
    averageSlope: 11°
    note: 中腹到 center house 前的寬廣緩坡，最大寬度約 120m，適合初學與家庭練習。
  - name: ダイヤモンドコース / Diamond Course
    difficulty: intermediate
    length: 2,500m
    maxSlope: 17°
    averageSlope: 14°
    note: 全季主雪道，北向谷狀坡面雪質穩定，course side 地形也有變化。
  - name: ゴールドコース / Gold Course
    difficulty: intermediate
    length: 520m
    maxSlope: 18°
    averageSlope: 15°
    note: 從 Panorama Course 分出的北側 bypass，斜度變化與狹窄坡面帶來速度感。
  - name: ダイナミックコース / Dynamic Course
    difficulty: advanced
    length: 4,000m
    maxSlope: 24°
    averageSlope: 10°
    note: 沿南側尾根滑下的 4,000m 長距離 course，下半部可用 Champion Quad 重複滑行。
  - name: パノラマコース / Panorama Course
    difficulty: advanced
    length: 2,550m
    maxSlope: 21°
    averageSlope: 15°
    note: 從山頂往北側尾根滑下，官方說明 course 約 90% 為天然雪，降雪時可能以未壓雪呈現。
  - name: スーパーコース / Super Course
    difficulty: advanced
    length: 400m
    maxSlope: 27°
    averageSlope: 17°
    note: 從 Bamboo Course 接到 Diamond Course 的急斜面，北向坡面在降雪後常成為粉雪目標。
  - name: エキスパートコース / Expert Course
    difficulty: advanced
    length: 300m
    maxSlope: 27°
    averageSlope: 17°
    note: 從 Champion Quad 通往 Diamond Course 的單一坡面，壓雪後適合 carving。
  - name: テクニカルコース / Technical Course
    difficulty: advanced
    length: 350m
    maxSlope: 32°
    averageSlope: 23°
    note: 從 Panorama Course 上部接往 Diamond Course 的急斜面，官方說明平常多為饅頭斜面。
  - name: エキサイティングAコース / Exciting A Course
    difficulty: advanced
    length: 1,000m
    maxSlope: 26°
    averageSlope: 16°
    note: 滑雪學校專用 pole barn，official note 強調起伏與狹窄 course layout。
  - name: エキサイティングBコース / Exciting B Course
    difficulty: advanced
    length: 2,300m
    maxSlope: 30°
    averageSlope: 12°
    note: 上部為 30° 急斜面，未壓雪時難度較高；下部較寬，適合長轉彎。
  - name: チャレンジコース / Challenge Course
    difficulty: advanced
    length: 400m
    maxSlope: 29°
    averageSlope: 22°
    note: 從 Champion Course 分出並接往 Exciting B 的高難度寬坡，適合上級者長轉彎。
  - name: チャンピオンコース / Champion Course
    difficulty: advanced
    length: 2,250m
    maxSlope: 40°
    averageSlope: 12°
...
access:
  ...
  car:
    ...
    note: 官方頁面標示東海北陸自動車道高鷲 IC 起約 10 分；冬季需雪胎與雪道駕駛準備。
terrainSummary:
  beginner: Bamboo 與 Beginners 可組成長距離緩坡動線，適合從山頂慢慢滑回 base。
  intermediate: Diamond 與 Gold 是主要中級練習線，兼具寬度與地形變化。

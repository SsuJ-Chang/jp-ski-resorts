...
name:
  zhTw: 奧大山
  ja: 休暇村奥大山スキー場
  en: Kyukamura Oku-Daisen Ski Area
...
links:
  ...
  googleMaps: https://www.google.com/maps/search/?api=1&query=Kyukamura%20Oku-Daisen
contact:
  address:
    zhTw: 鳥取縣日野郡江府町御机 709-1
    ja: "〒689-4424 鳥取県日野郡江府町御机709-1"
    googleMaps: https://www.google.com/maps/search/?api=1&query=Kyukamura%20Oku-Daisen
  phone: 0859-75-2300
season:
  label: 2025-2026
  ...
  hours: 9:00-16:30
  note: 官方頁面以休暇村奥大山與鏡ヶ成スキー場名稱呈現同一雪場資訊；此 entry 依使用者提供的「奧大山」拆分整理，後續可視資料策略合併。
...
- label: 奧大山雪道圖
  ...
  sourceLabel: Kyukamura Oku-Daisen Official
tickets:
  season: 2025-2026
  currency: JPY
  source: https://www.qkamura.or.jp/daisen/ski/
...
courses:
  ...
  summary: 奧大山官方滑雪頁以休暇村奥大山與鏡ヶ成スキー場名稱介紹，規模為 3 條左右的親子與初中級練習型雪道，適合住宿、雪盆與基礎滑雪體驗。
  details:
  - name: 初心者ゲレンデ / Beginner Slope
    difficulty: beginner
    length: 180m
    maxSlope: 20°
    note: 官方說明為初學者斜面，旁邊有雪盆與雪地遊樂空間，適合親子與第一次滑雪。
  - name: 初心者パーク / Beginner Park
    difficulty: beginner
    note: 官方坡度比例中列為初級區，作為兒童與初學者雪上遊玩區域整理。
  - name: 中級者ゲレンデ / Intermediate Slope
    difficulty: intermediate
    length: 200m
    maxSlope: 23°
    note: 官方說明為中級者斜面，坡度較初級區高。
lifts:
  total: 1
access:
  fromOsaka:
  ...
  car:
    ...
    note: 可從米子自動車道江府 IC 或蒜山 IC 方向前往；冬季山區道路需雪胎或雪鏈。
terrainSummary:
  beginner: 初學者斜面與初學者 park 是主要區域，適合親子、雪盆與第一次滑雪。
  intermediate: 中級者斜面提供較高坡度的短距離練習。
  advanced: 官方資料未列出上級雪道。
  snowboard: 官方頁面未限制雪板，但實際滑行規則請以當季公告為準。
  powder: 規模偏練習與親子型，粉雪資訊待官方當季雪況確認。
externalContent:
  blogs: []
  vlogs: []
sources:
...
奧大山位於鳥取縣的大山山麓，地形公園與巡航斜面能放在同一天安排，滑行節奏比單純練習更有變化。放進大山旅程時，能和周邊雪場形成不同節奏；適合想把住宿、餐飲與滑行整合成停留型旅程的人。滑行之外，也能把雪景、休息與地方氛圍一起留下來。

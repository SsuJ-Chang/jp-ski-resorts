...
tickets:
  season: 2025-2026
  currency: JPY
  source: https://www.ishizuchi.com/ski/price
  note: 官方票價包含石鎚登山 Ropeway 與纜車套票、纜車單券、回數券、單回券及季票；兒童定義為中學生以下。
  plans:
    - name: Ropeway＋纜車共通 1 日券
      priceLines:
        - 成人：¥4,800
        - 兒童：¥3,300
    - name: Ropeway＋纜車共通上午券
      priceLines:
        - 成人：¥4,300
        - 兒童：¥2,800
    - name: Ropeway＋纜車共通下午券
      priceLines:
        - 成人：¥4,300
        - 兒童：¥2,800
    - name: 纜車 1 日券
...
courses:
  ...
  details:
    - name: 野餐園地雪道 / ピクニック園地コース
      difficulty: beginner
      note: 從 Ropeway 山頂站步行約 150m 抵達的緩坡，適合初學者；也設有雪上遊戲與雪橇空間。
    - name: 成就 A 雪道 / 成就Aコース
      difficulty: intermediate
      note: 從 Ropeway 山頂站步行約 5 分鐘，轉乘單人纜車後抵達的中上級雪道；晴天時可眺望石鎚山頂與瀨戶內海對岸的大山。
    - name: 成就 B 雪道 / 成就Bコース
      difficulty: advanced
      note: 中上級雪道；自然雪充足時可能以非壓雪狀態開放，旺季預計設置 mogul 雪道。
access:
  publicTransit:
  - label: JR 伊予西條站轉乘瀨戶內巴士
    steps:
    - 搭乘 JR 至伊予西條站。
    - 轉乘瀨戶內巴士前往石鎚 Ropeway 前，再銜接石鎚登山 Ropeway。
    estimatedTime: 約 55 分鐘
    difficulty: medium
    note: 路線巴士單程成人 ¥1,020、兒童 ¥510；班次需依官方時刻表確認。
  car:
    recommended: true
    snowTireRequired: true
    note: 松山市區經伊予小松 IC 約 1 小時 30 分；高松市區經伊予西條 IC 約 2 小時；高知或德島市區約 2 小時 30 分。泉屋與京屋旅館可提供停車，普通車停車費每日 ¥500 起；冬季需準備雪胎或防滑裝備。
sources:
  - label: 石鎚官方交通
    url: https://www.ishizuchi.com/ski/access
  - label: 石鎚官方雪票
    url: https://www.ishizuchi.com/ski/price
  - label: 石鎚官方雪道
    url: https://www.ishizuchi.com/ski/course
---

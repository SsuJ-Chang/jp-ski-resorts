...
links:
  ...
  googleMaps: https://www.google.com/maps/search/?api=1&query=Terakoya%20Ski%20Area%20Shiga%20Kogen
season:
  label: 2025-2026
  operatingPeriod: 2025/12/6-2026/5/6，實際依各區積雪與纜車公告調整
  hours: 9:10-15:50 左右，依官方即時狀態頁為準
...
courses:
  ...
  - name: Connection Course
    difficulty: beginner
    length: 500m
    note: 連接東館山 Forest Course，可接續中央區域最長約 6km 的滑行動線。
  - name: Eternal Course
    difficulty: intermediate
    length: 810m
    note: 位於 2,100m 級高海拔，官方說明雪況良好，可經東館山 Forest Course 連接 Giant 區域。
  - name: Philosophy Course
    difficulty: intermediate
    length: 940m
    note: 山頂可眺望岩菅山、北信五岳與北阿爾卑斯；2 月前後可能有樹冰景觀。
  - name: LIPS Course
    difficulty: intermediate
    length: 420m
    note: 位於 2,100m 級高海拔，官方說明可享受天然粉雪。
lifts:
  total: 2
access:
  fromTokyo:
    - label: "東京出發經長野"
      steps:
        - "從東京搭北陸新幹線到長野站。"
        - "從長野站東口搭直達巴士前往志賀高原，於一之瀨或高天原周邊下車後，利用雪場內纜車與滑行動線銜接。"
      estimatedTime: "長野後約 1.5-2 小時"
      difficulty: "hard"
      note: "寺小屋位於中央區域高海拔帶，進出高度依賴纜車、連絡雪道與當日開放狀況，需先確認回程動線。"
  car:
    recommended: true
    snowTireRequired: true
    note: "自駕可先到一之瀨或高天原周邊停車，再利用雪場內動線前往；從信州中野 IC 經國道 292 號進入志賀高原，冬季需準備雪胎或雪鏈。"
terrainSummary:
  beginner: Connection Course 可銜接東館山 Forest Course。
...
志賀高原寺小屋位於長野縣的志賀高原，樹冰與夜間燈景是鮮明記憶點，滑行之外也能把東北冬季景觀收進旅程。白天看山岳雪景，夜間看燈光下的冰雪輪廓，記憶點很明確；適合雙板與雪板同行，依各自節奏安排滑行重點。滑行之外，也能把雪景、休息與地方氛圍一起留下來。

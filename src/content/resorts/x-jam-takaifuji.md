...
links:
  ...
  facebook: https://www.facebook.com/xjamzo/
...
tickets:
  ...
  currency: JPY
  source: https://x-jam.jp/liftpass/
  note: X-JAM 高井富士、夜間瀨溫泉共通票。官網目前顯示 2025-2026 雪季價格；學齡前兒童免費，長者與 G 長者購票須出示年齡證明。
  plans:
    - name: 共通 1 日券
      priceLines:
...
courses:
  ...
  - name: がんばる雪道
    difficulty: beginner
    length: 350m
    note: 官方列為高井富士雪道之一；坡面設有迷你 boarder cross。
  - name: 大波小波雪道
    difficulty: beginner
    length: 250m
    note: 林間雪道，可感受波浪地形。
  ...
  - name: おったまげ連絡雪道
    difficulty: beginner
    length: 650m
    note: 平緩的林間連絡雪道，連接夜間瀨溫泉雪場。
  - name: ダウンスロープ雪道
    difficulty: intermediate
    length: 600m
    note: 天氣晴朗時可欣賞良好景觀的 downhill 雪道。
  - name: フリーウォール雪道
    difficulty: intermediate
    length: 650m
    maxSlope: 28deg
    note: 全場最大坡度的雪道，可串接ぴょこたん、あっちっち構成最長 2,000m 路線。
  - name: 楽ちん雪道
    difficulty: intermediate
    note: 官方列為高井富士雪道之一。
  - name: イケイケ雪道
    difficulty: intermediate
    length: 600m
    note: 雪上公園內設有大型連續 kicker 的雪道。
  - name: じゃむじゃむ雪道
    difficulty: mixed
    length: 550m
    note: 雪上公園內的 slope style 雪道。
lifts:
  total: 4
access:
  fromTokyo:
  - label: JR 長野站－湯田中－高井富士
    steps:
    - 從各地前往 JR 長野站，轉乘長野電鐵至湯田中站。
    - 由湯田中站搭計程車至高井富士。
    difficulty: medium
    note: 湯田中站至高井富士約 10km、20 分鐘。
    estimatedTime: 湯田中站起約 20 分鐘
  car:
    recommended: true
    snowTireRequired: true
    note: 東京方向經關越道、上信越道信州中野 IC，再走志賀中野收費道路、R292、R403；約 242km、200 分鐘。冬季請備妥雪胎或雪鏈。
terrainSummary:
  beginner: 初級雪道占 50%，從平緩寬闊的一整面雪坡到林間波浪雪道皆有配置。
  intermediate: 中級雪道占 40%，包含 downhill 與 park 雪道；實際設施配置以當日公告為準。
  advanced: 高級雪道占 10%；高井富士的 park 從入門到進階設施均有安排。
  snowboard: 官方稱有最多 47 項設施的日本最大級雪上公園，雙板與單板皆可使用。
---

X-JAM 高井富士與夜間瀨溫泉雪場以連絡雪道和纜車相接，持共通票可跨雪場滑行。高井富士本身有 13 條雪道，初級與中級坡面占九成，從寬闊平緩的「なんじゃこりゃ」到林間波浪雪道都有安排。

雪場的核心特色是最多 47 項設施的雪上公園，分為不同難度帶；想練基本動作、玩 park，或轉往夜間瀨溫泉的中斜面與景觀雪道，都能在同一張票的範圍內規劃。
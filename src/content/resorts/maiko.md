...
links:
  ...
  ticket: https://www.maiko-resort.com/winter/lift.html
  access: https://www.maiko-resort.com/winter/access.html
  weather: https://www.maiko-resort.com/winter/gelande.html
...
courses:
  ...
  details:
    - name: O3 奧添地 Run Run／奥添地ランラン
      ...
      maxSlope: 10°
      averageSlope: 6°
      note: 位於奧添地區的平緩長距離滑道，是全長約 6,000m 連續下滑路線的一部分。
    - name: O5 Run Run／ルンルン
      difficulty: beginner
      length: 300m
      maxSlope: 12°
      averageSlope: 10°
      note: 纜車吊廂下站前方的短距離暖身滑道。
    - name: O7 Raku Raku／ラクラク
      difficulty: beginner
      length: 400m
      maxSlope: 9°
      averageSlope: 6°
      note: 前往奧添地四人與雙人纜車的平緩路線。
    - name: M19 Paradise／パラダイス
      difficulty: beginner
      length: 760m
      maxSlope: 15°
      averageSlope: 10°
      note: 舞子區的主要寬闊滑道，適合初學者與中階者練習轉彎。
    - name: M20 Kinder／キンダー
      difficulty: beginner
      length: 930m
      maxSlope: 10°
      averageSlope: 8°
      note: 寬闊且坡度平緩的長距離初級滑道。
    - name: M21 Easy／イージー
      difficulty: beginner
      length: 300m
      maxSlope: 9°
    ...
    - name: M22 Bambi／バンビ
      ...
      maxSlope: 9°
      averageSlope: 7°
      note: 適合想在較安靜環境練習的初學者。
    - name: M23 Family／ファミリー
      difficulty: beginner
      length: 480m
      maxSlope: 7°
      averageSlope: 6°
      note: 可銜接舞子停車場一帶的平緩滑道。
    - name: M24 Romance／ロマンス
      difficulty: beginner
      length: 830m
      maxSlope: 8°
      averageSlope: 7°
    ...
    - name: N3 長峰 Run Run／長峰ランラン
      ...
      maxSlope: 9°
      averageSlope: 6°
      note: 自奧添地一路滑下的長距離初級路線，串連全長約 6,000m 的下滑體驗。
    - name: N12 Choi Choi／チョイチョイ
      difficulty: beginner
      length: 700m
      maxSlope: 5°
      averageSlope: 4°
      note: 下半段穿越隧道的緩坡，受兒童歡迎。
    - name: O4 Gui Gui／グイグイ
      difficulty: intermediate
      length: 940m
      maxSlope: 23°
      averageSlope: 13°
      note: 寬闊放射狀的中斜面，熟悉犁式轉彎的初學者也可挑戰。
    - name: O6 Sui Sui／スイスイ
      difficulty: intermediate
      length: 500m
      maxSlope: 20°
      averageSlope: 10°
      note: 自纜車吊廂山頂出發，可經繞道銜接初級滑道。
    - name: O8 San San／サンサン
      difficulty: intermediate
      length: 300m
      maxSlope: 13°
      averageSlope: 10°
      note: 位於右側、寬度充足的中級滑道。
    - name: M13 Dolphin／ドルフィン
      difficulty: intermediate
      length: 1,370m
      maxSlope: 29°
      averageSlope: 11°
      note: 沒有初級繞道路線；降雪後可享受較深的積雪。
    - name: M15 Bronze／ブロンズ
      difficulty: intermediate
      length: 500m
      maxSlope: 18°
      averageSlope: 14°
      note: 可眺望景色的中斜面，夜間可欣賞夜景；合流處須留意。
    - name: M16 Gold／ゴールド
      difficulty: intermediate
      length: 180m
      maxSlope: 27°
      averageSlope: 22°
      note: 人氣中級斜面，降雪後與形成不整地時各有不同滑行感受。
    - name: M17 Silver／シルバー
      difficulty: intermediate
      length: 300m
      maxSlope: 26°
      averageSlope: 21°
      note: 狹窄、坡度變化明顯的技術型滑道。
    - name: M18 Riesen／リーゼン
      difficulty: intermediate
      length: 680m
      maxSlope: 18°
      averageSlope: 9°
      note: 曾舉辦比賽的中級滑道。
    - name: N9 Gin Gin／ギンギン
      difficulty: intermediate
      length: 670m
      maxSlope: 22°
      averageSlope: 15°
      note: 位於日照較短區域，積雪狀態通常較佳；下段左彎處須注意。
    - name: N11 Byun Byun／ビュンビュン
      difficulty: intermediate
      length: 800m
      maxSlope: 17°
      averageSlope: 10°
      note: 寬闊中斜面，適合大幅度 carving，但須控制速度。
    - name: O1 Gun Gun／グングン
      difficulty: advanced
      length: 820m
      maxSlope: 24°
      averageSlope: 15°
      note: 中央為不整地練習區，右側較少不整地；降雪後有粉雪地形。
    - name: O2 Zoku Zoku／ゾクゾク
      difficulty: advanced
      length: 410m
      maxSlope: 28°
      averageSlope: 20°
      note: 降雪後接近非整地感受，不整地時適合進階者挑戰。
    - name: M14 Champion／チャンピオン
      difficulty: advanced
      length: 170m
      maxSlope: 32°
      averageSlope: 30°
      note: 舞子區最具挑戰性的陡坡，滑行狀況受天候影響。
    - name: N10 Gan Gan／ガンガン
      difficulty: advanced
      length: 800m
      maxSlope: 24°
      averageSlope: 14°
      note: 可遇到粉雪與不整地，適合作為進階者技術練習。
access:
  fromTokyo:
    - label: 東京站
      steps:
        - 東京站搭乘上越新幹線至越後湯澤站，約 70 分鐘
        - 由越後湯澤站搭乘免費接駁車至舞子高原飯店約 20 分鐘，至舞子滑雪中心約 30 分鐘
      estimatedTime: 約 1 小時 40 分鐘
      difficulty: easy
      note: 免費接駁車時刻與停靠站依雪季公告。
      links:
        - label: 舞子滑雪場交通資訊

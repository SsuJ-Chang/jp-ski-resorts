...
name:
  zhTw: 茶臼山高原
  ja: 茶臼山高原スキー場
  en: Chausuyama Kogen Ski Resort
region: chubu
prefecture: 愛知縣
tags:
- beginner_friendly
...
courses:
  ...
  - name: Aコース
    ...
    maxSlope: 22°
    averageSlope: 13°
    note: 官方標示初中級者向，較平緩但局部有較陡段落。
  - name: Bコース
    difficulty: intermediate
    length: 1,000m
    maxSlope: 25°
    averageSlope: 18°
    note: 官方標示初中級者向，可依程度與 A コース搭配滑行。
  - name: Cコース
    difficulty: advanced
    length: 600m
    maxSlope: 30°
...
茶臼山高原位於愛知縣，氛圍偏輕鬆友善，適合把親子同行、練習與雪地遊玩排在一起。節奏不必排得太滿，反而能慢慢感受雪面、空氣與山景變化；適合親子同行或想用輕鬆節奏累積滑行經驗的人。滑行之外，也能把雪景、休息與地方氛圍一起留下來。

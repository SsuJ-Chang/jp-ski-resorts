...
season:
  ...
  source: https://ishiuchi.or.jp/en/price/
trailMaps:
- label: 石打丸山雪場圖
  language: 日本語
  season: 2025-2026
...
terrainSummary:
  beginner: 山麓側有較容易使用的寬緩路線。
  intermediate: 中段與主要區域適合巡航與重複練習。
  advanced: 高處與非壓雪區域有較具挑戰性的路線。
  powder: 官方 tree run/ungroomed 頁面列出非壓雪與樹林滑行區。
externalContent:
  blogs: []
  vlogs: []
sources:
- label: Ishiuchi Maruyama Ski Resort Official Website
  url: https://ishiuchi.or.jp/en/
- label: Ishiuchi Maruyama Ski Resort Course / Trail Map
  url: https://ishiuchi.or.jp/en/winter/ski/lift-course/
- label: Ishiuchi Maruyama Ski Resort Ticket
  url: https://ishiuchi.or.jp/en/price/
---

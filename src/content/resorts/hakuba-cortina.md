...
season:
  ...
  source: https://www.hgp.co.jp/cortina/ski/charge/
trailMaps:
- label: 白馬Cortina雪場圖
  language: 日本語
  season: 2025-2026
...
access:
  ...
  - label: 東京出發
    ...
    links:
    - label: Hakuba Cortina Snow Resort Access
      url: https://www.hgp.co.jp/cortina/ski/access/
  car:
    recommended: false
...
白馬Cortina位於長野縣的白馬山麓，粉雪與樹林地形是主要記憶點，降雪後能感受更立體的雪面變化。放進白馬旅程時，能和周邊雪場形成不同節奏；適合喜歡粉雪、林間變化與自然地形的人。滑行之外，也能把雪景、休息與地方氛圍一起留下來。
